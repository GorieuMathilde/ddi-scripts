...
${CLI})
  echo "executing script on Cli server!"
    ...
    sudo -u pst_prd cp ~/ddi-web-service-1.0-SNAPSHOT.war /nfs/public/rw/webadmin/tomcat/bases/pride/tc-pst-prider-ws_test/deploy/ddi-web-service-1.0-SNAPSHOT.war
...
*)
  ...
  scp ~/.m2/repository/uk/ac/ebi/ddi/ddi-web-service/1.0-SNAPSHOT/ddi-web-service-1.0-SNAPSHOT.war ${CLI}:
